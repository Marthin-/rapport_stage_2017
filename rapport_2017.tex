...
\subsection{Script de gestion de la puppetdb}

% python pour voir les ressources

\chapter{Autres missions}

En plus des missions mentionnées plus haut, il m'a été confié d'autres tâches en parallèle, qui relèvent plus des tâches d'exploitation courante
